class BinarySearchTree {
  ...
  /** Write a method to count the number of leaves in the tree.
   * Your method should return a number as an output.
   * If the tree only has a single node, return 1.
   * Add your solution to the countLeaves() method.
   * */
  countLeaves(count = 0) {
    // your solution here
  ...
  /**  Write an algorithm that checks if a BST is height-balanced
   * (i.e., the height of the left subtree differs from the height
   * of the right subtree by no more than 1), returning the height
   * of the BST if it is balanced, or -1 otherwise.
   * Add your solution to the isBalancedBST() method. */
  isBalancedBST() {
